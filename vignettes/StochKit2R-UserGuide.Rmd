...
(Note: on Windows, the above code will ask you to install additional tools. You must install the tools. After installing the tools, you may need to rerun the call to devtools::install_github("kevinsanft/StochKit2R").) 
...
ssa and tauLeaping run ensembles (multiple simulation trajectories) and output data at regularly spaced intervals. They have nearly identical function calls. Consult the help pages for information. Here are the key arguments:
...
The file structure may look complicated at first glance, but is actually quite simple!
...
5. My simulation crashes without any helpful messages.
