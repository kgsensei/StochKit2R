...
* outputDir: the path to the output directory. By default (=NULL) which writes no file. If the directory does not exist, it will be created. If the directory already exists, an error will occur unless force=TRUE is specified (see below).
