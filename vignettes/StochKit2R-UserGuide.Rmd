...
```
-->
StochKit2R is available on github. You may install from source on all platforms using devtools::install_github (see below). Or, you may install a precompiled binary on Windows and Mac (see below).
