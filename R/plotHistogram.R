...
#'
#'@param histogramData histogram data from output object or string with path to StochKit2 histogram output file. IMPORTANT: histogram file names have format hist_<species index>_<time point>.dat, where species index STARTS AT 0 (not 1!)
...
#'plotHistogram("ex_out/histograms/hist_1_4.dat",file=TRUE) # from file
#'}
